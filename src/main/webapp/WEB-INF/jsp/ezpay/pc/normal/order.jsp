...
<script type="text/javascript">
    ...
    function f_init()
    {
        ...
        frm_pay.EP_product_amt.value    = "100";                                 //상품금액
...
//        frm_pay.EP_return_url.value     = "http://가맹점URL/web/normal/order_res.jsp";      // Return 받을 URL (HTTP부터 입력)
        frm_pay.EP_return_url.value     = "http://192.168.100.78:8080/ezpay/pc/normal/order_res";      // Return 받을 URL (HTTP부터 입력)
        ...
        frm_pay.EP_vacct_end_date.value = "20231231";                              //입금 만료 날짜
...
<input type="hidden" id="EP_charset"        name="EP_charset"           value="EUC-KR">   <!-- 가맹점 CharSet // EUC-KR,UTF-8 사용시 대문자 이용-->
...
<tr>
    ...
    <table border="0" width="900" cellpadding="0" cellspacing="0">
    <tr>
        <td height="30" bgcolor="#FFFFFF">&nbsp;<img src="/img/arow2.gif" border="0" align="absmiddle">&nbsp;<b>주문 정보</b>(*필수)</td>
    </tr>
    </table>
    ...
    <tr height="25">
        ...
        <td bgcolor="#FFFFFF" width="300">&nbsp;<input type="text" id="EP_product_nm" name="EP_product_nm" value="테스트상품" size="50" class="input_A"></td>
