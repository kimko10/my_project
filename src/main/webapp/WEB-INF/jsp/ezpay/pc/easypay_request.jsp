...
<%
    ...
    /* -------------------------------------------------------------------------- */
    final String CERT_FILE              = "C:/carrot/workspace/kuder/src/main/webapp/WEB-INF/jsp/ezpay/cert";
    final String LOG_DIR                = "C:/carrot/workspace/kuder/src/main/webapp/WEB-INF/jsp/ezpay/log";
    ...
    /* -------------------------------------------------------------------------- */
    if ( tr_cd.length() > 0 ) {
    	System.out.println("HJLOG tr_cd.length : " + tr_cd.length());
    	System.out.println("HJLOG mall_id : " + mall_id);
    	System.out.println("HJLOG tr_cd : " + tr_cd);
    	System.out.println("HJLOG order_no : " + order_no);
    	System.out.println("HJLOG CERT_FILE : " + CERT_FILE + " LOG_DIR : " + LOG_DIR);
    	
        easyPayClient.easypay_run( mall_id, tr_cd, order_no );

        res_cd = easyPayClient.res_cd;
        res_msg = easyPayClient.res_msg;
    	System.out.println("HJLOG res_msg : " + res_msg);
    }
    else {
        res_cd  = "M114";
...
<form name="frm" method="post" action="/ezpay/pc/result">
