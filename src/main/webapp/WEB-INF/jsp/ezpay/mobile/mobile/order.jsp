...
<script type="text/javascript">
    ...
    {           
        ...
        frm_pay.sp_product_amt.value    = "100";                                 //상품금액
        ...
        frm_pay.sp_vacct_end_date.value = "20161231";                              //입금 만료 날짜
        frm_pay.sp_vacct_end_time.value = "153025";                                //입금 만료 시간
    }
...
alert('frm_pay.sp_order_no.value : ' + frm_pay.sp_order_no.value);
                   
//            frm_pay.sp_return_url.value = "/ezpay/mobile/mobile/order_res_submit";                                  
            frm_pay.sp_return_url.value = "http://localhost:8080/ezpay/mobile/mobile/order_res_submit";                                  
            //frm_pay.sp_return_url.value = "http://testpg.easypay.co.kr/easypay_test/EP8.0Webpay_Mobile/easypay80_webpay_mobile_jsp/mobile/mobile/order_res_submit.jsp";                                  
            easypay_card_webpay(frm_pay,"/ezpay/mobile/mobile/order_req","_self","0","0","submit",30);
   ...
   /* 승인 요청 */
    function f_submit() 
    {
        ...
        if( frm_pay.sp_res_cd.value == "0000" )
        {
            ...
            frm_pay.action = "/ezpay/mobile/easypay_request";
            frm_pay.submit();
        }
    }
    ...
    <div class="contents">
        <section class="section00 bg_skyblue">
           ...
           <div class="btnMidNext" align="center"><!-- //button guide에서 button 참고하여 작성 -->
              ...
              <a href="/easypay_test/index/mobile80_webpay_index.jsp" class="btnBox_blue"><span class="btnWhiteVlines">돌아가기</span></a>
          </div>
        </section>
    </div>
</div><br>
<footer class="center margin_b12">
  <p>
      <img src='/img/common/k-logo.gif' width="50" height="9" alt="kicc"> <span class="cop1">Copyrightⓒ 2015 KICC All right reserved</span>
  </p>
</footer>
</form>
</body>
